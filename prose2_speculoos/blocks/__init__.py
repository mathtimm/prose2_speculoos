...
# from prose2_speculoos import Block
# import sys, inspect
# import importlib
#
#
...
#
# __all__ = flatten([
#     submodules_blocks(prose2_speculoos._blocks),
#     # submodules_blocks(prose2_speculoos._diagnostics),
#     # submodules_blocks(prose2_speculoos.neural),
# ])