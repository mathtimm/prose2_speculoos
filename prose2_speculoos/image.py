...
class Image:
    ...
    When a FITS path (or header) is provided, keyword values are used to identify and instantiate a :py:class:`~prose2_speculoos.Telescope` object. Image attributes then use this object to retrieve specific image information such as ra, dec, untis... etc
    ...
    .. jupyter-execute::
        ...
        from prose2_speculoos.tutorials import image_sample
    ...
    def plot_marks(self, coordinates, label=None, ax=None, **kwargs):
        ...
        .. jupyter-execute::
            ...
            from prose2_speculoos import archive
            import matplotlib.pyplot as plt
