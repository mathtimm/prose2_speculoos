...
class Telescope:
    ...
    Once a new telescope is instantiated its dictionary is permanantly saved by prose2_speculoos and automatically used whenever the telescope name is encountered in a fits header. Saved telescopesare located in ``~/.prose2_speculoos`` as ``.telescope`` files (yaml format).
    ...
    .. jupyter-execute::
        ...
        from prose2_speculoos import Telescope
